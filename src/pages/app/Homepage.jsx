...
function Homepage() {
  return (
    <div className="flex px-[20px] flex-col items-center justify-center min-h-screen overflow-y-hidden overflow-x-hidden bg-gradient-to-r from-green-400 via-blue-500 to-purple-600">
